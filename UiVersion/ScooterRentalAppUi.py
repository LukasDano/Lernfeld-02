...
def getRandomStandort():
    return random.randint(MINDEST_ENTFERNUNG, MAXIMALE_ENTFERNUNG)
    
for i in range(10):
    scooter_for_list = scooter(i + 1, getRandomStandort())
...
def scooterAusleihen():
    ...
    formattedPricePerMinute = "{:.2f}".format(PRICE_PER_MINUTE_DRIVE)
    ...
    print(f"Die Gebühr zum Ausleihen eines Scooters beträgt {PRICE_PER_MINUTE_DRIVE}€")
